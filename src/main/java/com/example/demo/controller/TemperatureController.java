...
public class TemperatureController {
    ...
    public Flux<Integer> getTemperature() {
        ...
        return Flux.fromStream(Stream.generate(() -> r.nextInt(high - low) + low)
                ...
                //.onErrorContinue((e,i)->{System.out.println("Error occured  "+i);} )
    ...
    private class CustomeException extends Throwable {
        public CustomeException(String s) {
            System.out.println("There has been an error occured in the division");
        }
    }
}
